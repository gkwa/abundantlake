...
import (
	...
	"github.com/gkwa/abundantlake/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.abundantlake.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".abundantlake")
	}
